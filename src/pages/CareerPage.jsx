      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="max-w-2xl text-sm leading-relaxed text-gray-500">
            If you believe you have the right combination of passion, proficiency and tenacity to join our team, then perhaps JB Automation is the place for you!
            Apply for vacant positions, Pl. fill following form. You can also Contact Us on email or phone given on the page.
          </motion.p>
        </motion.div>
